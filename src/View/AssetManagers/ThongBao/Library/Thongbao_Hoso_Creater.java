...
public class Thongbao_Hoso_Creater {
	private final NGUOIDUNG user;
	@SuppressWarnings("unused")
	private final Controler controler;

	public Thongbao_Hoso_Creater(NGUOIDUNG user) {
		this.user = user;
	...
	public void create_THONGBAO_Congvieccuatoi_CapnhatHoSo_THUCHIEN_SUACHUA(DOT_THUCHIEN_SUACHUA_BAODUONG congviec,
		...
		(new Thongbao_CongviecCuaToi_Sender(user)).GuiThongbao_PhanviecCuatoi_Cho_CanboThamgia(
				"Cập nhật hồ sơ Công việc: [SỬA CHỮA PTTS: " + (new Thongbao_CongviecCuaToi_Sender(user)).TenCongviec(congviec)
