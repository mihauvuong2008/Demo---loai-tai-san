	...
	public String getString_update_PHUONGTIEN_GIAOTHONG(PHUONGTIEN_GIAOTHONG phuongtien_Giaothong) {
		try {
			...
			return "UPDATE PHUONGTIEN_GIAOTHONG SET TEN_PHUONGTIEN_GIAOTHONG = '"
					...
					+ "', THOIHAN_DANGKIEM='" + mdf.getSQLStringDate(phuongtien_Giaothong.getTHOIHAN_DANGKIEM())
					+ "', MA_TAISAN = '" + phuongtien_Giaothong.getMA_TAISAN() + "', XANG_DAU = '"
					+ phuongtien_Giaothong.getXANG_DAU()
					+ (phuongtien_Giaothong.getMA_KYHAN_DANGKIEM() <= 0 ? ""
