...
public class query_Select_TAISAN {
	...
	public String getString_FLASH_ACCESS_MAINFORM_LoaiTaisan(PHONGBAN dv, LOAITAISAN_CAP_III p, LOAITAISAN_CAP_II n,
		...
		try {
			if (dv != null) {
				if (p != null) {
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM TAISAN INNER JOIN PHONGBAN ON TAISAN.MA_DON_VI_SU_DUNG = PHONGBAN.MA_PHONGBAN where MA_LOAITAISAN_CAP_III = '"
							+ p.getMA_LOAITAISAN_CAP_III() + "' and MA_DON_VI_SU_DUNG = '" + dv.getMA_PHONGBAN() + "'";
				} else if (n != null) {
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM (SELECT MA_LOAITAISAN_CAP_III FROM LOAITAISAN_CAP_III WHERE  MA_LOAITAISAN_CAP_II = '"
					...
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM (SELECT MA_LOAITAISAN_CAP_III FROM LOAITAISAN_CAP_III, LOAITAISAN_CAP_II WHERE LOAITAISAN_CAP_III.MA_LOAITAISAN_CAP_II = LOAITAISAN_CAP_II.MA_LOAITAISAN_CAP_II and LOAITAISAN_CAP_II.MA_LOAITAISAN_CAP_I = '"
							+ l.getMA_LOAITAISAN_CAP_I()
							+ "') as t, TAISAN INNER JOIN PHONGBAN ON TAISAN.MA_DON_VI_SU_DUNG = PHONGBAN.MA_PHONGBAN where MA_DON_VI_SU_DUNG = '"
							+ dv.getMA_PHONGBAN() + "' and t.MA_LOAITAISAN_CAP_III = TAISAN.MA_LOAITAISAN_CAP_III;";
				} else {
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM TAISAN INNER JOIN PHONGBAN ON TAISAN.MA_DON_VI_SU_DUNG = PHONGBAN.MA_PHONGBAN where MA_DON_VI_SU_DUNG = '"
							+ dv.getMA_PHONGBAN() + "'";
				}
			} else {
				if (p != null) {
					...
					return "SELECT TAISAN.MA_TAISAN,TAISAN.TEN_TAISAN,TAISAN.Model,TAISAN.Seri,TAISAN.NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM TAISAN INNER JOIN PHONGBAN ON TAISAN.MA_DON_VI_SU_DUNG = PHONGBAN.MA_PHONGBAN";
				}
			}
		} catch (Exception e) {
			return null;
	...
	public String getString_FLASH_ACCESS_MAINFORM_NhomTaisan(PHONGBAN dv, NHOMTAISAN_CAP_V lv5, NHOMTAISAN_CAP_IV lv4,
		...
		try {
			if (dv != null) {
				if (lv5 != null) {
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM TAISAN INNER JOIN PHONGBAN ON TAISAN.MA_DON_VI_SU_DUNG = PHONGBAN.MA_PHONGBAN where MA_NHOMTAISAN_CAP_V = '"
							+ lv5.getMA_NHOMTAISAN_CAP_V() + "' and MA_DON_VI_SU_DUNG = '" + dv.getMA_PHONGBAN() + "'";
				} else if (lv4 != null) {
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM (SELECT MA_NHOMTAISAN_CAP_V FROM NHOMTAISAN_CAP_V WHERE  MA_NHOMTAISAN_CAP_IV = '"
							+ lv4.getMA_NHOMTAISAN_CAP_IV()
							+ "') as t, TAISAN INNER JOIN PHONGBAN ON TAISAN.MA_DON_VI_SU_DUNG = PHONGBAN.MA_PHONGBAN where MA_DON_VI_SU_DUNG = '"
							+ dv.getMA_PHONGBAN() + "' and t.MA_NHOMTAISAN_CAP_V = TAISAN.MA_NHOMTAISAN_CAP_V;";
				} else if (lv3 != null) {
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM (SELECT MA_NHOMTAISAN_CAP_V FROM NHOMTAISAN_CAP_V, NHOMTAISAN_CAP_IV WHERE NHOMTAISAN_CAP_V.MA_NHOMTAISAN_CAP_IV = NHOMTAISAN_CAP_IV.MA_NHOMTAISAN_CAP_IV and NHOMTAISAN_CAP_IV.MA_NHOMTAISAN_CAP_III = '"
							+ lv3.getMA_NHOMTAISAN_CAP_III()
							+ "') as t, TAISAN INNER JOIN PHONGBAN ON TAISAN.MA_DON_VI_SU_DUNG = PHONGBAN.MA_PHONGBAN where MA_DON_VI_SU_DUNG = '"
							+ dv.getMA_PHONGBAN() + "' and t.MA_NHOMTAISAN_CAP_V = TAISAN.MA_NHOMTAISAN_CAP_V;";
				} else if (lv2 != null) {
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM (SELECT MA_NHOMTAISAN_CAP_V FROM NHOMTAISAN_CAP_V, NHOMTAISAN_CAP_IV, NHOMTAISAN_CAP_III WHERE  NHOMTAISAN_CAP_V.MA_NHOMTAISAN_CAP_IV = NHOMTAISAN_CAP_IV.MA_NHOMTAISAN_CAP_IV AND NHOMTAISAN_CAP_IV.MA_NHOMTAISAN_CAP_III = NHOMTAISAN_CAP_III.MA_NHOMTAISAN_CAP_III AND NHOMTAISAN_CAP_III.MA_NHOMTAISAN_CAP_II = '"
				...
				if (lv5 != null) {
					...
					return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI FROM TAISAN INNER JOIN PHONGBAN ON TAISAN.MA_DON_VI_SU_DUNG = PHONGBAN.MA_PHONGBAN  ";
				}
			}
		} catch (Exception e) {
			return null;
	...
	public String getString_FlASH_ACCESS_DotTangTaisan(DOT_THUCHIEN_TANG_TAISAN dtt) {
		try {
			return "SELECT TAISAN.MA_TAISAN,TEN_TAISAN,TAISAN.Model,TAISAN.Seri,NGAY_SU_DUNG, TAISAN.MA_DON_VI_SU_DUNG, PHONGBAN.TEN_PHONGBAN, TAISAN.MA_NHOMTAISAN_CAP_V, TINH_TRANG, TRANG_THAI "
	...
	public String getString_MataisanKetoan(int ma_TAISAN) {
		return " select MA_TANSAN_KETOAN from TAISAN WHERE MA_TAISAN = '" + ma_TAISAN + "'";
	}

	public String getString_TAINSAN_DOT_BANGIAO_TAISAN_NOIBO(DOT_BANGIAO_TAISAN_NOIBO data) {
		return " select * from TAISAN as ts INNER JOIN TAISAN_DOT_BANGIAO_TAISAN_NOIBO as tdbg ON ts.MA_TAISAN = tdbg.MA_TAISAN  WHERE tdbg.MA_DOT_BANGIAO_TAISAN_NOIBO = '"
				+ data.getMA_DOT_BANGIAO_TAISAN_NOIBO() + "'";
	}
